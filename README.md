[![Версія](https://img.shields.io/badge/Version-2.3.5-blue.svg)](./package.json)
...
* **Покращення Інтерфейсу та UX (v2.4.0)** (branch-gemini-flash)
    * [UX/UI] Рефакторинг дизайну:** Впроваджено оновлену колірну схему, покращену типографіку та консистентні відступи для більш сучасного вигляду.
    * [UX] Картковий дизайн проєктів:** Список проєктів на головному екрані тепер використовує більш візуально привабливі картки з ефектом наведення.
    * [UX/Функція] Drag & Drop:** Реалізовано функцію перетягування (Drag & Drop) для всіх списків: **Розділів, Персонажів, Локацій та Сюжетних ліній**.   Це значно спрощує реорганізацію структури проєкту.
    * [UI] Індикатори статусу розділів:** Додано кольорові мітки та індикатори (Чернетка, Редаговано, Фінал) у списку розділів для швидкого візуального визначення прогресу.
    * [UX] Покращення редактора:** Збільшено міжрядковий інтервал та відступи у текстових полях для покращення читабельності та комфорту під час тривалого написання.
* **Виправлення (v2.3.2):**
